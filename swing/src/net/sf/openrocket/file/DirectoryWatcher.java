...
public class DirectoryWatcher implements Runnable, WatcherService {
    ...
    private final WatcherFilter<Path> mFilter;
    ...
    public static class Builder {
        ...
        private static final WatcherFilter<Path> NO_FILTER = path -> true;

        private final Set<Path> mWatched = new HashSet<>();
        private boolean mPreExistingAsCreated = false;
        private WatcherFilter<Path> mFilter = NO_FILTER;
        ...
        public Builder setFilter(WatcherFilter<Path> filter) {
            mFilter = filter;
            return this;
        }
